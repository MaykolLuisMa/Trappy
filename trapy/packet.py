...
class Packet:
    ...
    def build(self):
        ...
        checksum = make_checksum(pseudo_tcp_header+tcp_header + self.data)
    ...
    def corrupted(self):
        ...
        corrupted_tcp_checksum = make_checksum(pseudo_tcp_header + self.tcp_header + self.data) != tcp_checksum
